...
public class ChatCommand : IChatCommand
{
    ...
    public override string CommandName => "fashionsave";
    public override string HelpText => "usage: `/fashionsave password (PawnName)` - Saves the current fashion template using a password.";
    ...
    public override void Execute(DdonGameServer server, string[] command, GameClient client, ChatMessage message, List<ChatResponse> responses)
    {
        ...
        server.FashionManager.LockFashion(client, targetCharacter, password);
