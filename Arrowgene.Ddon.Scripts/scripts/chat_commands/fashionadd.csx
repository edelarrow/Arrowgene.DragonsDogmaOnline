...
public class ChatCommand : IChatCommand
{
    ...
    public override string CommandName => "fashionadd";
    public override string HelpText => "usage: `/fashionadd (PawnName)` - Modifies the current fashion templaate with what you're currently wearing.";
    ...
    public override void Execute(DdonGameServer server, string[] command, GameClient client, ChatMessage message, List<ChatResponse> responses)
    {
        ...
        server.FashionManager.AddFashionData(targetCharacter);
